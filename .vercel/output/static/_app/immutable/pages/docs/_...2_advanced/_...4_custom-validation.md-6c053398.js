...
<span class="line"></span></code></pre>`}}),e=new T({}),{c(){n=_("h1"),l=g(p),o=E(),D(t.$$.fragment),D(e.$$.fragment)},l(s){n=v(s,"H1",{});var c=h(n);l=b(c,p),c.forEach(y),o=B(s),F(t.$$.fragment,s),F(e.$$.fragment,s)},m(s,c){u(s,n,c),N(n,l),u(s,o,c),C(t,s,c),C(e,s,c),a=!0},p(s,[c]){(!a||c&1)&&p!==(p=s[0].title+"")&&S(l,p)},i(s){a||(i(t.$$.fragment,s),i(e.$$.fragment,s),a=!0)},o(s){A(t.$$.fragment,s),A(e.$$.fragment,s),a=!1},d(s){s&&y(n),s&&y(o),m(t,s),m(e,s)}}}function L(r,n,p){let l;return j(r,I,o=>p(0,l=o)),[l]}class Q extends f{constructor(n){super(),d(this,n,L,H,$,{})}}export{Q as default};
