import{S as N,i as O,s as U,w as g,x as w,y as x,f as S,t as h,B as v,E as j,l as f,r as R,a as T,m as u,n as d,u as I,h as e,c as q,b as C,M as $,v as L,_ as k}from"../../../chunks/index-29635d82.js";import{R as z,F as J}from"../../../chunks/Result-defa069c.js";import{F as K}from"../../../chunks/scroll-face605a.js";import{C as Q}from"../../../chunks/CodeFence-3b1ba0cf.js";import"../../../chunks/singletons-eb14b229.js";function V(o){let a,l;return a=new J({props:{form_name:X,fields:o[0],btnSubmit:{text:"Submit alter",classes:["btn","btn-primary"]},btnReset:{text:"Reset alter",classes:["btn","btn-secondary"]}}}),a.$on("submit",o[1]),{c(){g(a.$$.fragment)},l(n){w(a.$$.fragment,n)},m(n,p){x(a,n,p),l=!0},p:j,i(n){l||(S(a.$$.fragment,n),l=!0)},o(n){h(a.$$.fragment,n),l=!1},d(n){v(a,n)}}}function W(o){let a,l;return a=new z({props:{$$slots:{default:[V]},$$scope:{ctx:o}}}),{c(){g(a.$$.fragment)},l(n){w(a.$$.fragment,n)},m(n,p){x(a,n,p),l=!0},p(n,[p]){const r={};p&4&&(r.$$scope={dirty:p,ctx:n}),a.$set(r)},i(n){l||(S(a.$$.fragment,n),l=!0)},o(n){h(a.$$.fragment,n),l=!1},d(n){v(a,n)}}}const X="formly_alter";function Y(o){return[[{type:"input",name:"firstname",attributes:{type:"text",id:"firstname",placeholder:"Tap your first name"}},{type:"input",name:"password",attributes:{type:"password",id:"password",placeholder:"Tap your password"}}],n=>{console.log(n)}]}class Z extends N{constructor(a){super(),O(this,a,Y,W,U,{})}}function ss(o){let a,l=o[0].title+"",n,p,r,i=o[0].description+"",b,E,y,A,m,B,_,c,D,F;return c=new Q({props:{title:"Example",lang:"svelte",ext:"svelte",linesCount:43,highlightLines:[[34,41]],rawCode:`<script&#8203 lang="ts">
...
<span class="line"></span></code></pre>`}}),D=new Z({}),{c(){a=f("h1"),n=R(l),p=T(),r=f("p"),b=R(i),E=T(),y=f("p"),A=f("strong"),m=f("em"),B=R("Change textes & classes for buttons submit and reset"),_=T(),g(c.$$.fragment),g(D.$$.fragment)},l(s){a=u(s,"H1",{});var t=d(a);n=I(t,l),t.forEach(e),p=q(s),r=u(s,"P",{});var M=d(r);b=I(M,i),M.forEach(e),E=q(s),y=u(s,"P",{});var P=d(y);A=u(P,"STRONG",{});var G=d(A);m=u(G,"EM",{});var H=d(m);B=I(H,"Change textes & classes for buttons submit and reset"),H.forEach(e),G.forEach(e),P.forEach(e),_=q(s),w(c.$$.fragment,s),w(D.$$.fragment,s)},m(s,t){C(s,a,t),$(a,n),C(s,p,t),C(s,r,t),$(r,b),C(s,E,t),C(s,y,t),$(y,A),$(A,m),$(m,B),C(s,_,t),x(c,s,t),x(D,s,t),F=!0},p(s,[t]){(!F||t&1)&&l!==(l=s[0].title+"")&&L(n,l),(!F||t&1)&&i!==(i=s[0].description+"")&&L(b,i)},i(s){F||(S(c.$$.fragment,s),S(D.$$.fragment,s),F=!0)},o(s){h(c.$$.fragment,s),h(D.$$.fragment,s),F=!1},d(s){s&&e(a),s&&e(p),s&&e(r),s&&e(E),s&&e(y),s&&e(_),v(c,s),v(D,s)}}}function ns(o,a,l){let n;return k(o,K,p=>l(0,n=p)),[n]}class es extends N{constructor(a){super(),O(this,a,ns,ss,U,{})}}export{es as default};
