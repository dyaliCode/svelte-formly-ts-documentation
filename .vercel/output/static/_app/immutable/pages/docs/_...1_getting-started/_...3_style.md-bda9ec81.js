import{S as N,i as O,s as Q,l as x,r as f,a as g,w,m as q,n as k,u,h as t,c as B,x as L,p as T,b as o,M as j,y as I,v as G,f as H,t as S,B as M,_ as R}from"../../../chunks/index-29635d82.js";import{f as V}from"../../../chunks/scroll-967765ef.js";import{C as J}from"../../../chunks/CodeFence-8f67fe7a.js";import{L as K}from"../../../chunks/Link-1d5bbe41.js";import"../../../chunks/singletons-eb14b229.js";import"../../../chunks/contexts-cdaa50b4.js";function W(e){let a;return{c(){a=f("#")},l(l){a=u(l,"#")},m(l,p){o(l,a,p)},d(l){l&&t(a)}}}function X(e){let a;return{c(){a=f("#")},l(l){a=u(l,"#")},m(l,p){o(l,a,p)},d(l){l&&t(a)}}}function Y(e){let a,l=e[0].title+"",p,A,i,E=e[0].description+"",b,_,c,D,P,h,F,r,y,U,v,C,d;return D=new K({props:{class:"header-anchor",href:"#bootstrap","aria-hidden":"true",$$slots:{default:[W]},$$scope:{ctx:e}}}),F=new J({props:{title:"example",lang:"javascript",ext:"js",linesCount:61,highlightLines:[[8,8],[21,21],[42,42]],rawCode:`const fields: IField[] = [
	{
		type: 'input',
		name: 'email',
		attributes: {
...
<span class="line"><span style="color: #A6ACCD">	</span><span style="color: #89DDFF">}</span></span>
<span class="line"><span style="color: #A6ACCD">]</span><span style="color: #89DDFF">;</span></span>
<span class="line"></span></code></pre>`}}),{c(){a=x("h1"),p=f(l),A=g(),i=x("p"),b=f(E),_=g(),c=x("h2"),w(D.$$.fragment),P=f(" Bootstrap"),h=g(),w(F.$$.fragment),r=x("h2"),w(y.$$.fragment),U=f(" Tailwindcss"),v=g(),w(C.$$.fragment),this.h()},l(s){a=q(s,"H1",{});var n=k(a);p=u(n,l),n.forEach(t),A=B(s),i=q(s,"P",{});var $=k(i);b=u($,E),$.forEach(t),_=B(s),c=q(s,"H2",{id:!0,tabindex:!0});var m=k(c);L(D.$$.fragment,m),P=u(m," Bootstrap"),m.forEach(t),h=B(s),L(F.$$.fragment,s),r=q(s,"H2",{id:!0,tabindex:!0});var z=k(r);L(y.$$.fragment,z),U=u(z," Tailwindcss"),z.forEach(t),v=B(s),L(C.$$.fragment,s),this.h()},h(){T(c,"id","bootstrap"),T(c,"tabindex","-1"),T(r,"id","tailwindcss"),T(r,"tabindex","-1")},m(s,n){o(s,a,n),j(a,p),o(s,A,n),o(s,i,n),j(i,b),o(s,_,n),o(s,c,n),I(D,c,null),j(c,P),o(s,h,n),I(F,s,n),o(s,r,n),I(y,r,null),j(r,U),o(s,v,n),I(C,s,n),d=!0},p(s,[n]){(!d||n&1)&&l!==(l=s[0].title+"")&&G(p,l),(!d||n&1)&&E!==(E=s[0].description+"")&&G(b,E);const $={};n&2&&($.$$scope={dirty:n,ctx:s}),D.$set($);const m={};n&2&&(m.$$scope={dirty:n,ctx:s}),y.$set(m)},i(s){d||(H(D.$$.fragment,s),H(F.$$.fragment,s),H(y.$$.fragment,s),H(C.$$.fragment,s),d=!0)},o(s){S(D.$$.fragment,s),S(F.$$.fragment,s),S(y.$$.fragment,s),S(C.$$.fragment,s),d=!1},d(s){s&&t(a),s&&t(A),s&&t(i),s&&t(_),s&&t(c),M(D),s&&t(h),M(F,s),s&&t(r),M(y),s&&t(v),M(C,s)}}}function Z(e,a,l){let p;return R(e,V,A=>l(0,p=A)),[p]}class os extends N{constructor(a){super(),O(this,a,Z,Y,Q,{})}}export{os as default};
