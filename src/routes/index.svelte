	...
	<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
		<nav class="relative z-50 flex justify-between">
			...
			<div class="flex items-center gap-x-5 md:gap-x-8">
				<div class="md:block">
					<a
						class="group inline-flex items-center justify-center rounded-full py-2 px-4 text-sm font-semibold focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 bg-gray-900 text-white hover:text-slate-100 hover:bg-orange-500 active:bg-orange-800 active:text-orange-100 focus-visible:outline-orange-600"
						href="https://github.com/dyaliCode/svelte-formly"
						target="_blink"><span>Github</span></a
					>
				</div>
			</div>
		</nav>
