	...
	<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
		<nav class="relative z-50 flex justify-between">
			...
			<div class="flex items-center gap-x-5 md:gap-x-8">
				<div class="md:block">
					<a
						class="group inline-flex items-center justify-center rounded-full focus:outline-none text-slate-700 hover:text-slate-900 hover:ring-slate-300 active:bg-slate-100 active:text-slate-600 focus-visible:outline-blue-600 focus-visible:ring-slate-300"
						href="https://github.com/dyaliCode/svelte-formly"
						target="_blink"
					>
						<svg
							class="h-6 w-6 flex-none fill-orange-600 group-active:fill-current"
							aria-hidden="true"
							focusable="false"
							data-prefix="fab"
							data-icon="github"
...
<main>
	<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32">
		...
		>
			<span class="relative whitespace-nowrap text-orange-600"
				><span class="relative">Svelte</span></span
			> Formly
		</h1>
	...
	>
		...
		<div class="bg-blue-400 shadow-lg shadow-blue-400/50 text-center p-10 rounded-xl">
			<div class="w-full">
				<svg
					xmlns="http://www.w3.org/2000/svg"
					width="16"
		...
		<div class="bg-zinc-400 shadow-lg shadow-zinc-400/50 text-center p-10 rounded-xl">
			<div class="w-full">
				<svg
					...
					height="16"
					fill="currentColor"
					class="bi bi-speedometer2 w-full h-10"
					viewBox="0 0 16 16"
				>
					<path
